...
- **Infrastructure as Code:** Proficient in **Terraform** for provisioning and managing cloud resources.
- **Cloud Engineering:** Extensive experience with **Google Cloud SDK (gcloud)** and CLI-driven administration.
- **Certifications:** Completed Google Cloud Computing Foundations and the Cloud Engineering Learning Path.

### 💻 Full-Stack Development (freeCodeCamp & Harvard)
- **Relational Databases:** Designing and querying PostgreSQL databases (fCC).
- **Frontend:** Responsive Web Design (HTML/CSS) and **Front-End Development Libraries** (React, Bootstrap, etc.).
- **Backend & Logic:** JavaScript Algorithms, Data Structures, and Python for Data Science.
- **Foundations:** Harvard CS50 (x, p, w) — Mastery of C, Python, and Web Security.

### 📊 Data Science & Analysis
- **Data Analysis:** Using SQL and Probability to drive cloud spend insights.
- **Modeling:** Statistical modeling with Python to predict resource scaling needs.
